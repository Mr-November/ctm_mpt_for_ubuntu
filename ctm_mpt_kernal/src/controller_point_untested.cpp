...
int main (int argc, char** argv)
{
    ...
    if (ros::ok())
	{
		...
		std::string f0q("/home/stalin/CTM/src/ctm_mpt_for_ubuntu-master/ctm_mpt_kernal/src/zero_qs_1");
		std::string f0x("/home/stalin/CTM/src/ctm_mpt_for_ubuntu-master/ctm_mpt_kernal/src/zero_rs_1");
...
/* 		if (!fin.is_open()||!fiq.is_open()||!fix.is_open()||!fixi.is_open())
		...
		O_zero[2] = 0;// the z of floor is zero
